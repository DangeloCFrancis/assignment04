...
*What is the relationship between GRDP, household income, and women's rights on fertility among South Koreans?*
...
Despite the alarming decrease in birthrates, visualization 4A seems to suggest that South Koreans are resigned to lower fertility. This possibly suggests that Korean society has gradually accepted Korean women as equal to men. However, graph 4B suggests otherwise. It appears that South Korea has gone *backwards* in achieving gender equality--far from the world benchmark. 
