...
rok_fertility_province <- 
  ...
  mutate(shapeName = case_when(
    shapeName == "Chungcheongbuk-do" ~ "North Chungcheong Province",
    shapeName == "Chungcheongnam-do" ~ "South Chungcheong Province",
    shapeName == "Jeollabuk-do" ~ "North Jeolla Province",
    shapeName == "Jeollanam-do" ~ "South Jeolla Province",
    shapeName == "Gyeongsangbuk-do" ~ "North Gyeongsang Province",
    shapeName == "Gyeongsangnam-do" ~ "South Gyeongsang Province",
    shapeName == "Jeju-do" ~ "Jeju Province",
    .default = shapeName
    )
  )
